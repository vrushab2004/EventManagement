              ...
              Stack(
                children: [
                  Container(
                    ...
                    // child: Image.asset('assets/bkgg.jpg',fit: BoxFit.fill,),
                  ),
              Center(
                child: Container(
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(onPressed: (){
                      ...
                      children: [
                        ...
                        Text('  Continue With Phone ',style:GoogleFonts.aBeeZee(color:Colors.white,fontWeight:FontWeight.bold,fontSize:18)),
                      ],
